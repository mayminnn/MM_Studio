...
namespace Test_Cases.Project_Explorer.Bins
{
    ...
    public class tFJ_80 : BaseTest
    {
        ...
        public void Blank_SW_Bin()
        {
            ...
            Assert.IsTrue(
                binSheet.VerifyValidationSuccessLog("Field value of SW Bin cannot be empty."));

            //Assert.IsTrue(
            //    binSheet.VerifyValidationSuccessLog("Softbin or hardware bin number cannot use 0"));

            Debug.WriteLine("-----------------------------");
            Debug.WriteLine("| Blank SW Bin check passed |");
            Debug.WriteLine("-----------------------------");
            ...
            //Debug.WriteLine("-------------------------------");
            //Debug.WriteLine("| 0 value SW Bin check passed |");
            //Debug.WriteLine("-------------------------------");
